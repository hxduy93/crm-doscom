...
const TRANSLATE_SYS = `You are a professional US-English e-commerce copywriter translating Vietnamese WooCommerce product content into natural, fluent, SEO-optimized American English.
RULES:
...
// Dịch nội dung tiếng Việt (bản user đã duyệt) sang tiếng Anh cho nomaauto.us.
async function translateToEN(env, vn) {
