...
//
// 2026-05-27: switched từ Gemini hybrid sang Claude Haiku 4.5 only theo
// yêu cầu user (đồng bộ với FB/Google/GEO agent đã chuyển Haiku).
// Cost ~$0.003/conv với fastpath cover ~60% query → cost thực ~$1-3/tháng.
//
// Pipeline mỗi chat:
...
// ====================================================================
// LLM call — Claude Haiku 4.5 via Cloudflare AI Gateway
// ====================================================================
