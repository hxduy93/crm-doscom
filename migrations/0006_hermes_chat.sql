-- Hermes-inspired chat agent — Phase 1
-- Tạo 3 bảng cho khung chat trên dashboard:
...
--
-- Multi-user: phân chia theo user_email (lấy từ session cookie HMAC).
-- Bind D1: env.DB (cùng database doscom_geo).
...
-- ====================================================================
-- Mỗi user có thể tích lũy preferences theo thời gian. Inject vào system
-- prompt mỗi conversation. Khi user nói "luôn báo cáo gọn bullet point"
-- → save vào đây để lần sau agent tự nhớ.
